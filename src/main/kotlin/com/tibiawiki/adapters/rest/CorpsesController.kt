...
class CorpsesController(
    ...
    fun getCorpses(
        ...
        return WikiObjectResponses.list(expand, retrieveCorpses.corpsesJSON, retrieveCorpses.corpsesList)
    }
    ...
    fun getCorpsesByName(@PathVariable("name") name: String): ResponseEntity<String> {
        return WikiObjectResponses.byName(retrieveCorpses.getCorpseJSON(name))
    }
    ...
    fun putCorpse(@RequestBody corpse: Corpse, @RequestHeader("X-WIKI-Edit-Summary") editSummary: String?): ResponseEntity<WikiObject> {
        return WikiObjectResponses.modify(modifyAny.modify(corpse, editSummary))
    }
}
