...
public class LootStatisticsResource {
    ...
    private RetrieveLoot retrieveLoot;

    @Autowired
    private LootStatisticsResource(RetrieveLoot retrieveLoot) {
        this.retrieveLoot = retrieveLoot;
    }
    ...
    public Response getLoot(@ApiParam(value = "optionally expands the result to retrieve not only " +
        ...
        return Response.ok()
                .entity(expand != null && expand
                        ? retrieveLoot.getLootJSON().map(JSONObject::toMap)
