...
class RetrieveOutfitsTest {
    ...
    fun testGetOneJSON() {
        ...
        val result: Optional<JSONObject> = target.getOutfitJSON(SOME_PAGE_NAME)
    ...
    companion object {
        ...
        private const val SOME_NAME = "Citizen Outfits"
        private const val SOME_OTHER_NAME = "Hunter Outfits"
