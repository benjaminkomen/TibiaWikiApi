...
class BooksController(
    ...
    fun getBooks(
        ...
        return WikiObjectResponses.list(expand, retrieveBooks.booksJSON, retrieveBooks.booksList)
    }
    ...
    fun getBooksByName(@PathVariable("name") name: String): ResponseEntity<String> {
        return WikiObjectResponses.byName(retrieveBooks.getBookJSON(name))
    }
    ...
    fun putBook(@RequestBody book: Book, @RequestHeader("X-WIKI-Edit-Summary") editSummary: String?): ResponseEntity<WikiObject> {
        return WikiObjectResponses.modify(modifyAny.modify(book, editSummary))
    }
}
