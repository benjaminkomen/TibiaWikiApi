...
class LootStatisticsController(
    ...
    fun getLoot(
        ...
        return WikiObjectResponses.list(expand, retrieveLoot.getLootJSONObject(), retrieveLoot.getLootList())
    }
    ...
    fun getLootByName(@PathVariable("name") name: String): ResponseEntity<String> {
        return WikiObjectResponses.byName(retrieveLoot.getLootJSONObject("Loot_Statistics:$name"))
    }
}
