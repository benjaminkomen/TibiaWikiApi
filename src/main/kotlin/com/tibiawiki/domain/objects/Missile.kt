...
data class Missile(
    ...
    override fun getTemplateType(): String {
        return InfoboxTemplate.MISSILE.templateName
    }

    override fun fieldOrder(): List<String> {
        return listOf(
            "name", "implemented", "missileid", "primarytype", "secondarytype", "lightradius", "lightcolor",
