...
class RetrieveEffects(
    ...
    val effectsList: List<String>
        get() {
            val category = articleRepository.getPageNamesFromCategory(InfoboxTemplate.EFFECT.categoryName)
    ...
    val effectsJSON: Stream<JSONObject>
        get() = getArticlesFromInfoboxTemplateAsJSON(effectsList)

    fun getEffectJSON(pageName: String): Optional<JSONObject> {
