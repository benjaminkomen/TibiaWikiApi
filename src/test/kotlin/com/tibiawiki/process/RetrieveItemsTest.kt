...
class RetrieveItemsTest {
    ...
    fun testGetOneJSON() {
        ...
        val result: Optional<JSONObject> = target.getItemJSON(SOME_PAGE_NAME)
    ...
    companion object {
        ...
        private const val SOME_NAME = "Carlin Sword"
        private const val SOME_OTHER_NAME = "Magic Plate Armor"
