...
class AchievementsController(
    ...
    fun getAchievements(
        ...
        return WikiObjectResponses.list(expand, retrieveAchievements.achievementsJSON, retrieveAchievements.achievementsList)
    }
    ...
    fun getAchievementsByName(@PathVariable("name") name: String): ResponseEntity<String> {
        return WikiObjectResponses.byName(retrieveAchievements.getAchievementJSON(name))
    }
    ...
    fun putAchievement(@RequestBody achievement: Achievement, @RequestHeader("X-WIKI-Edit-Summary") editSummary: String?): ResponseEntity<WikiObject> {
        return WikiObjectResponses.modify(modifyAny.modify(achievement, editSummary))
    }
}
