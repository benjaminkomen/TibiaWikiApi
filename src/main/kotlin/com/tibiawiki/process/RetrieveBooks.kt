...
class RetrieveBooks(
    ...
    val booksList: List<String>
        get() {
            val category = articleRepository.getPageNamesFromCategory(InfoboxTemplate.BOOK.categoryName)
    ...
    val booksJSON: Stream<JSONObject>
        get() = getArticlesFromInfoboxTemplateAsJSON(booksList)

    fun getBookJSON(pageName: String): Optional<JSONObject> {
