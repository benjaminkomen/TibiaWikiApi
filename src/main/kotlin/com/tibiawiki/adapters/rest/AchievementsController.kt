...
class AchievementsController(
    ...
    fun getAchievements(
        ...
        return WikiResourceResponses.list(expand, { retrieveAchievements.achievementsJSON }, { retrieveAchievements.achievementsList })
    }
    ...
    fun getAchievementsByName(@PathVariable("name") name: String): ResponseEntity<WikiJson> {
        return WikiResourceResponses.jsonOrNotFound(retrieveAchievements.getAchievementJSON(name))
    }
    ...
    fun putAchievement(@RequestBody achievement: Achievement, @RequestHeader("X-WIKI-Edit-Summary") editSummary: String?): ResponseEntity<WikiObject> {
        return WikiResourceResponses.modify(modifyAny.modify(achievement, editSummary))
    }
}
