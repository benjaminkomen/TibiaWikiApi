...
class RetrieveQuestsTest {
    ...
    @Test
    fun testGetQuestsJSON_ZeroResults() {
    ...
    @Test
    fun testGetQuestsJSON_TwoResults() {
    ...
    @Test
    fun testGetQuestJSON() {
        doReturn("").`when`(articleRepository).getArticle(SOME_PAGE_NAME)

        val result: Optional<Map<String, Any>> = target.getQuestJSON(SOME_PAGE_NAME)
    ...
    companion object {
        ...
        private const val SOME_NAME = "Demon Helmet"
        private const val SOME_OTHER_NAME = "The Postman Missions"
